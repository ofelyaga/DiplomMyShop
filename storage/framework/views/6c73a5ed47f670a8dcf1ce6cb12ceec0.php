<?php $__env->startSection('content'); ?>
    ...
    <section class="mt-16 lg:mt-24">
        ...
        <div class="mt-12 text-center">
            <a href="<?php echo e(route('catalog')); ?>" class="btn btn-purple">Все товары &nbsp;→</a>
        </div>
    </section>
    ...
    <section class="mt-20">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 2xl:grid-cols-6 gap-4 md:gap-8 mt-12">
            <?php echo $__env->renderEach('catalog.shared.brand', $brands, 'item'); ?>
        </div>
    </section>
<?php $__env->stopSection(); ?>


<?php echo $__env->make('layouts\app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\OSPanel\domains\DiplomaShop\resources\views/index.blade.php ENDPATH**/ ?>