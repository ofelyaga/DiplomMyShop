<div class="product-card flex flex-col rounded-3xl bg-card">
    <a href="#" class="product-card-photo overflow-hidden h-[320px] rounded-3xl">
        <img src="<?php echo e($item->makeThumbnail('345x320',$item->thumbnail)); ?>" class="object-cover w-full h-full"
             alt="<?php echo e($item->title); ?>">
    </a>
    <div class="grow flex flex-col py-8 px-6">
        <h3 class="text-sm lg:text-md font-black"><a href="#"
                                                     class="inline-block text-white hover:text-pink"><?php echo e($item->title); ?></a>
        </h3>
        <div class="mt-auto pt-6">
            <div class="mb-3 text-sm font-semibold"><?php echo e($item->price); ?> ₽</div>
...
<?php /**PATH C:\OSPanel\domains\DiplomaShop\resources\views/catalog/shared/product.blade.php ENDPATH**/ ?>