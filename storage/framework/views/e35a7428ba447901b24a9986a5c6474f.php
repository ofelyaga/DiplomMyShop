        ...
        <div class="header-inner flex items-center justify-between lg:justify-start">
            <div class="header-logo shrink-0">
                <a href="<?php echo e(route('home')); ?>" rel="home">
                    <img src="<?php echo e(Vite::image('logo.svg')); ?>"
                         class="w-[120px] xs:w-[148px] md:w-[201px] h-[30px] xs:h-[36px] md:h-[50px]" alt="Logo">
                </a>
            </div><!-- /.header-logo -->
            <div class="header-menu grow hidden lg:flex items-center ml-8 mr-8 gap-8">
                <form action="<?php echo e(route('catalog')); ?>" class="hidden lg:flex gap-3">
                    <input name="s"
                ...
                <nav class="hidden 2xl:flex gap-8">
                    <a href="<?php echo e(route('home')); ?>" class="text-white hover:text-pink font-bold">Главная</a>
                    <a href="<?php echo e(route('catalog')); ?>" class="text-white hover:text-pink font-bold">Каталог товаров</a>
            ...
            <div class="header-actions flex items-center gap-3 md:gap-5">
                ...
                <?php if(auth()->guard()->check()): ?>
                    <div x-data="{dropdownProfile: false}" class="profile relative">
                        <button @click="dropdownProfile = ! dropdownProfile"
                            ...
                            <img src="<?php echo e(auth()->user()->avatar); ?>" class="shrink-0 w-7 md:w-9 h-7 md:h-9 rounded-full"
                                 alt="<?php echo e(auth()->user()->name); ?>">
                            <span class="hidden md:block ml-2 font-medium"><?php echo e(auth()->user()->name); ?></span>
                        ...
                        >
                            ...
                            <div class="flex items-center mt-3">
                                <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-11 h-11 rounded-full" alt="Данил Шуцкий">
                                <span class="ml-3 text-xs md:text-sm font-bold"><?php echo e(auth()->user()->name); ?></span>
                            </div>
                            <div class="mt-4">
                                <ul class="space-y-2">
                                    <li><a href="#"
                ...
                <?php elseif(auth()->guard()->guest()): ?>
                    <a href="<?php echo e(route('login')); ?>" class="profile hidden xs:flex items-center">
                        ...
                        <span
                            class="profile-text relative ml-2 text-white text-xxs md:text-xs font-bold">Войти</span>
                    </a>
                <?php endif; ?>
...
<?php /**PATH C:\OSPanel\domains\DiplomaShop\resources\views/shared/header.blade.php ENDPATH**/ ?>