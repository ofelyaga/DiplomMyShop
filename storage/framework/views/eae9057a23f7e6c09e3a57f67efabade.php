        ...
        <div class="flex flex-wrap lg:flex-nowrap items-center">
            <div class="footer-logo order-0 basis-full sm:basis-1/2 lg:basis-1/3 shrink-0 text-center sm:text-left">
                <a href="<?php echo e(route('home')); ?>" class="inline-block" rel="home">
                    <img src="<?php echo e(Vite::image('logo.svg')); ?>" class="w-[155px] h-[38px]" alt="Logo">
                </a>
            </div><!-- /.footer-logo -->
            <div class="footer-copyright order-2 lg:order-1 basis-full lg:basis-1/3 mt-8 lg:mt-0">
                <div class="text-[#999] text-xxs xs:text-xs sm:text-sm text-center">MyDiplomaShop, <?php echo e(now()->year); ?>
                ...
                <div class="flex flex-wrap items-center justify-center sm:justify-end space-x-6">
                    <a href="#" class="inline-flex items-center text-white hover:text-pink" target="_blank"
                       rel="nofollow noopener">
                        <img class="h-5 lg:h-6" src="<?php echo e(Vite::image('icons/youtube.svg')); ?>" alt="YouTube">
                        <span class="ml-2 lg:ml-3 text-xxs font-semibold">YouTube</span>
                    </a>
                    <a href="#" class="inline-flex items-center text-white hover:text-pink" target="_blank"
                       rel="nofollow noopener">
                        <img class="h-5 lg:h-6" src="<?php echo e(Vite::image('icons/telegram.svg')); ?>" alt="Telegram">
        ...
        <div class="mmenu-heading flex items-center pt-6 xl:pt-12">
            <div class="shrink-0 grow">
                <a href="<?php echo e(route('home')); ?>" rel="home">
                    <img src="<?php echo e(Vite::image('logo.svg')); ?>" class="w-[148px] md:w-[201px] h-[36px] md:h-[50px]"
                         alt="CutCode">
                </a>
            </div>
        ...
        <div class="mmenu-inner pt-10">
            ...
            <?php if(!is_null(auth()->user())): ?>
                <div class="flex items-center">
                    <img src="<?php echo e(auth()->user()->avatar); ?>" class="w-14 h-14 rounded-full" alt="<?php echo e(auth()->user()->name); ?>">
                    <div class="flex flex-col items-start ml-4">
                        <span class="text-dark text-xs md:text-sm font-bold"><?php echo e(auth()->user()->name); ?></span>
...
<?php /**PATH C:\OSPanel\domains\DiplomaShop\resources\views/shared/footer.blade.php ENDPATH**/ ?>